...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/telemetryprofiles/{telemetryprofileId}/sensor/{sensorId}".format(
        client.base_url, telemetryprofileId=telemetryprofile_id, sensorId=sensor_id
    )
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        sensor_id (str):  Example: 0af401df-7d7a-1f36-817d-7b0a058d0003.
